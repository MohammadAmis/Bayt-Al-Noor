...
class _UserSelectionPageState extends ConsumerState<UserSelectionPage> {
      ...
      floatingActionButton: _selectedUsers.length > 1
          ? FloatingActionButton.extended(
              onPressed: () => Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      GroupDetailsPage(selectedUsers: _selectedUsers.toList()),
                ),
              ),
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                          user.status ?? 'Hey there! I am using Bayt-Al-Noor.'),
  ...
  void _handleUserTap(ProfileEntity user) async {
    if (_selectedUsers.isNotEmpty) {
      ...
      final existingChatId = await ref
          .read(chatRepositoryProvider)
          .findExistingPrivateChat(user.id);
